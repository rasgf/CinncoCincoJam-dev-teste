...
export async function GET() {
  try {
    // Adicionar professores de demonstração
    const professors = [
      {
        id: 'prof1',
        data: {
    ...
    return NextResponse.json({ 
      success: true, 
      message: 'Cursos de demonstração adicionados com sucesso!',
      data: {
    ...
    console.error('Erro ao adicionar cursos de demonstração:', error);
    return NextResponse.json({ 
      success: false, 
      message: 'Erro ao adicionar cursos de demonstração',
